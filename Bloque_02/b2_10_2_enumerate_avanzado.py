...
resultado_final_lista = list(resultado_final.items())
resultado_final_lista_enumerada = enumerate(resultado_final_lista, start=1)

for indice, (nombre_estudiante, datos) in resultado_final_lista_enumerada:
    print(
        f"{indice} {nombre_estudiante} - "
